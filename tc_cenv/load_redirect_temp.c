// C Implementation of user space application
...
#define BPF_PROG_PATH "redirect_egress.o" // Path to your compiled eBPF program
...
int main() {
    ...
    struct bpf_program *prog = bpf_object__find_program_by_name(obj, "tc_egress_multiplicate"); // Replace with your program's name
    if (!prog) {
